...
`lacosmic==1.4.0`; GPU tests use the scaled float64 pixel tolerance in the
[benchmark guide](../bench/README.md) and require the saved mask exactly.
The generated scaled FITS case checks both commands: zero iterations remain
bitwise equal, while cleaned pixels may differ within the same tolerance.
